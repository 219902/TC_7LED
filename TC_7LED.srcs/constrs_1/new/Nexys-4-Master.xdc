...
set_property PACKAGE_PIN F15 [get_ports BUTTON_RESET]						
...
set_property PACKAGE_PIN V10 [get_ports BUTTON_SIGNAL]						
	set_property IOSTANDARD LVCMOS33 [get_ports BUTTON_SIGNAL]
 


##Pmod Header JA
##Bank = 15, Pin name = IO_L1N_T0_AD0N_15,					Sch name = JA1
set_property PACKAGE_PIN B13 [get_ports {SIGNAL}]					
